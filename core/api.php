...
class Prompt_Api {
	...
	/**
	 * Get the default list for site-wide posts as they are published.
	 *
	 * @since 2.0.0
	 *
	 * @return Prompt_Interface_Subscribable
	 */
	public static function site_posts_list() {
		return new Prompt_Site();
	}

	/**
	 * Get the default list for periodic digests of posts if available.
	 *
	 * @since 2.0.0
	 *
	 * @return Prompt_Interface_Subscribable
	 */
	public static function digests_list() {
		return apply_filters( 'prompt/api/digests_list', null );
	}
